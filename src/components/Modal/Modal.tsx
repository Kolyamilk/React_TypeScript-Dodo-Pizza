    ...
    return (
        <>
            ...
            <div className={className}>
                ...
                <div className="sm">
                    <Button className='big' onClick={() => { }}>Выслать код</Button>
