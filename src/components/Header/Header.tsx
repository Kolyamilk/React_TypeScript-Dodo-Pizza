            ...
            <header className='header-main'>
                    ...
                    <div className="header-left__logo">
                        <a href="/" className='svg-logo'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="250" height="42" fill="none" viewBox="0 0 250 42">
                                <g clipPath="url(#0abaab07-5c50-483f-91e0-4caf5aef401aa)">
                                ...
                                <g clipPath="url(#80f63d66-52ca-4b3d-8e92-fd51e876e85db)">
                ...
                <div className="header-right">
                    <a href="/" className='header-right__dodo-coins'>
                        <span className='icon'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fillRule="evenodd" d="M11 1a1 1 0 0 1 1 1v2a8 8 0 1 1 0 16v2a1 1 0 1 1-2 0v-2H6.6c-.56 0-.84 0-1.05-.1a1 1 0 0 1-.44-.45C5 19.24 5 18.96 5 18.4V5.6c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C5.76 4 6.04 4 6.6 4H10V2a1 1 0 0 1 1-1m1 17a6 6 0 0 0 0-12H7v12z" clipRule="evenodd"></path></svg></span>
