            ...
            <div className='header-nav'>
                <nav className='header-nav__main'>
                    <li className="nav-main__item">
                        <a href="#" className='nav-main__link'>Прямой Эфир</a>
                    </li>
                    <li className="nav-main__item">
                        <a href="#" className='nav-main__link'>Работа в Додо</a>
                    </li>
                    <li className="nav-main__item">
                        <a href="#" className='nav-main__link'>О нас</a>
                    </li>
                    <li className="nav-main__item">
                        <a href="#" className='nav-main__link'>Контакты</a>
                    </li>
                </nav>
            </div>
                    ...
                    <div className="header-left__logo">
                        <a href="/" className='svg-logo'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="250" height="42" fill="none" viewBox="0 0 250 42">
                                ...
                                <defs>
                                    <clipPath id="0abaab07-5c50-483f-91e0-4caf5aef401aa"><path fill="#fff" d="M0 0h42v42H0z"></path>
                                    </clipPath>
                                    <clipPath id="80f63d66-52ca-4b3d-8e92-fd51e876e85db"><path fill="#fff" d="M49 0h201v42H49z"></path>
                                    </clipPath>
                                </defs>
                            </svg>
                        </a>
                        <div className="header-left__logo-name">
                            <p className='fz-14'>Сеть №1 в России</p>
                            <a href='/' className='dodoColor fz-14'>по количеству пиццерий</a>
                        </div>
                    </div>
                    <div className="header-left__deliveryTime">
                        <span className='fz-18'>Доставка пиццы <span className='dodoColor'>Москва</span></span>
                        <div>31 мин <i className='dot'></i> <span>4.8</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16" className="sc-1824ck7-3 ldYizc">
                                <defs><linearGradient id="a429ec50-38ae-4702-b133-26ea25e8175fa"><stop offset="50%" stop-color="#FFD200"></stop><stop offset="50%" stop-color="#999" stop-opacity="0.5"></stop></linearGradient></defs><path fill="url(#a429ec50-38ae-4702-b133-26ea25e8175fa)" d="M8.451 1.49a1 1 0 0 0-.902 0c-.245.123-.378.359-.461.528-.09.182-.185.427-.296.712l-.928 2.39a3 3 0 0 1-.07.173v.002H5.79c-.036.006-.086.01-.184.02l-2.504.214c-.272.024-.51.044-.695.077-.176.032-.418.09-.6.274a1 1 0 0 0-.28.826c.03.256.186.45.307.583.126.139.302.3.503.485l1.987 1.823.125.118.002.002v.003c-.006.033-.016.079-.036.168l-.592 2.66a9 9 0 0 0-.145.73c-.024.184-.042.445.087.68a1 1 0 0 0 .733.508c.265.038.504-.072.667-.16a9 9 0 0 0 .632-.392l2.036-1.332c.086-.056.13-.085.164-.104L8 12.476l.003.002c.033.019.078.048.164.104l2.036 1.332c.246.161.458.3.632.393.163.087.401.197.667.159a1 1 0 0 0 .733-.508c.13-.235.11-.496.087-.68a9 9 0 0 0-.145-.73l-.592-2.66c-.02-.09-.03-.135-.035-.168v-.003l.001-.002.125-.118 1.987-1.823c.201-.185.377-.346.503-.485.12-.133.276-.327.308-.583a1 1 0 0 0-.281-.826c-.182-.183-.424-.242-.6-.274-.185-.033-.423-.053-.695-.077l-2.504-.215a3 3 0 0 1-.184-.018h-.003l-.002-.003a3 3 0 0 1-.069-.172l-.928-2.39a10 10 0 0 0-.296-.713c-.083-.17-.216-.405-.46-.529"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                <div className="header-right">
                    <a href="/" className='header-right__dodo-coins'>
                        <span className='icon'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11 1a1 1 0 0 1 1 1v2a8 8 0 1 1 0 16v2a1 1 0 1 1-2 0v-2H6.6c-.56 0-.84 0-1.05-.1a1 1 0 0 1-.44-.45C5 19.24 5 18.96 5 18.4V5.6c0-.56 0-.84.1-1.05a1 1 0 0 1 .45-.44C5.76 4 6.04 4 6.6 4H10V2a1 1 0 0 1 1-1m1 17a6 6 0 0 0 0-12H7v12z" clip-rule="evenodd"></path></svg></span>
                        <span className='fz-14'>Додокойны</span>
                    </a>
                    <Button type='submit' className='small gray' onClick={() => setModalLogin(true)}>Войти</Button>
